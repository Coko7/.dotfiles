...
awful.screen.connect_for_each_screen(function(s)
	...
	local names = { "M", "www", "term", "note", "chat", "draw", "game", "8", "misc" }
...
-- Create a table for sxhkd keybindings
local sxhkd_keys = {
	-- system bindings
	...
	awful.key({ "Shift" }, "Print", function() end, { description = "take monitor screenshot", group = "flameshot" }),
	awful.key(
		{ "Control" },
		"Print",
		function() end,
